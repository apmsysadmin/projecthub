                ...
                <div class="col-lg-10">
                    ...
                    <div class="mb-3 mt-2">
                        ...
                        <div class="row">
                            ...
                            {!! create_label('removed_from_favorite_successfully', 'Removed from favorites successfully.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            {!! create_label('account_creation_email_will_not_sent','If Deactive, account creation email notification won\'t be sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            {!! create_label('project_assignment_email_will_not_sent','If Deactive, project assignment email notification won\'t be sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            ...
                            {!! create_label('task_assignment_email_will_not_sent','If Deactive, task assignment email notification won\'t be sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            ...
                            {!! create_label('workspace_assignment_email_will_not_sent','If Deactive, workspace assignment email notification won\'t be sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            ...
                            {!! create_label('meeting_assignment_email_will_not_sent','If Deactive, meeting assignment email notification won\'t be sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            ...
                            {!! create_label('project_assignment_sms_will_not_sent','If Deactive, project assignment SMS notification won\'t be sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            ...
                            {!! create_label('task_assignment_sms_will_not_sent','If Deactive, task assignment SMS notification won\'t be sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            ...
                            {!! create_label('workspace_assignment_sms_will_not_sent','If Deactive, workspace assignment SMS notification won\'t be sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            ...
                            {!! create_label('meeting_assignment_sms_will_not_sent','If Deactive, meeting assignment SMS notification won\'t be sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            {!! create_label('leave_request_creation_email_will_not_sent', 'If Deactive, Leave Request Creation email notification won\'t be sent',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            {!! create_label('leave_request_status_updation_email_will_not_sent', 'If Deactive, Leave Request Status Updation email notification won\'t be sent',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            {!! create_label('leave_request_creation_sms_will_not_sent', 'If Deactive, Leave Request Creation SMS notification won\'t be sent',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            {!! create_label('leave_request_status_updation_sms_will_not_sent', 'If Deactive, Leave Request Status Updation SMS notification won\'t be sent',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            ...
                            {!! create_label('project_status_updation_email_will_not_sent', 'If Deactive, Project Status Updation email notification won\'t be sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('task','Task',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            {!! create_label('project_status_updation_sms_will_not_sent', 'If Deactive, Project Status Updation SMS notification won\'t be sent',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            {!! create_label('task_status_updation_sms_will_not_sent', 'If Deactive, Task Status Updation SMS notification won\'t be sent',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            ...
                            {!! create_label('team_member_on_leave_alert_email_will_not_sent', 'If Deactive, Team Member on Leave Alert email notification won\'t be sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            {!! create_label('default_push_template_info','A Default Title and Message Will Be Used if a Specific Push Notification Template Is Not Set.',Session::get('locale')) !!}
                            {!! create_label('project_assignment_push_info', 'This template will be used for the push notification sent to users/clients when they are assigned a project.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('project_assignment_push_will_not_sent', 'If Deactive, project assignment push notification won\'t be sent',Session::get('locale')) !!}
                            {!! create_label('project_status_updation_push_info', 'This Template Will Be Used for the push notification sent to the Users/Clients Upon the Status Updation of a Project.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('project_status_updation_push_will_not_sent', 'If Deactive, Project Status Updation push Notification won\'t be sent',Session::get('locale')) !!}
                            {!! create_label('task_assignment_push_info', 'This template will be used for the push notification sent to users/clients when they are assigned a task.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('task_assignment_push_will_not_sent', 'If Deactive, task assignment push notification won\'t be sent',Session::get('locale')) !!}
                            {!! create_label('task_status_updation_push_info', 'This Template Will Be Used for the push notification sent to the Users/Clients Upon the Status Updation of a Task.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('task_status_updation_push_will_not_sent', 'If Deactive, Task Status Updation push notification won\'t be sent',Session::get('locale')) !!}
                            {!! create_label('workspace_assignment_push_info', 'This template will be used for the push notification sent to users/clients when they are added to a workspace.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('workspace_assignment_push_will_not_sent', 'If Deactive, workspace assignment push notification won\'t be sent',Session::get('locale')) !!}
                            {!! create_label('meeting_assignment_push_info', 'This template will be used for the push notification sent to users/clients when they are added to a meeting.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('meeting_assignment_push_will_not_sent', 'If Deactive, meeting assignment push notification won\'t be sent',Session::get('locale')) !!}
                            {!! create_label('leave_request_creation_push_info', 'This Template Will Be Used for the push notification sent to the Admin and Leave Editors Upon the Creation of a Leave Request.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('leave_request_creation_push_will_not_sent', 'If Deactive, Leave Request Creation push notification won\'t be sent',Session::get('locale')) !!}
                            {!! create_label('leave_request_status_updation_push_info', 'This Template Will Be Used for the push notification sent to the Admin/Leave Editors/Requestee Upon the Status Updation of a Leave Request.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('leave_request_status_updation_push_will_not_sent', 'If Deactive, Leave Request Status Updation push Notification won\'t be sent',Session::get('locale')) !!}
                            {!! create_label('team_member_on_leave_alert_push_info', 'This template will be used for the push notification sent to team members upon approval of a leave request, informing them about the absence of the requestee.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('team_member_on_leave_alert_push_will_not_sent', 'If Deactive, Team Member on Leave Alert push Notification Won\'t be Sent',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            ...
                            {!! create_label('you_will_be_task_participant_automatically', 'You will be task participant automatically.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            {!! create_label('use_primary_lang_for_auth_interfaces', 'Use the primary language chosen by the main admin for the signup, login, forgot password, and reset password interfaces.',Session::get('locale')) !!}
                            {!! create_label('auth_primary_lang_enabled', 'Use the primary language chosen by the main admin for the signup, login, forgot password, and reset password interfaces is enabled.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('auth_primary_lang_disabled', 'Use the primary language chosen by the main admin for the signup, login, forgot password, and reset password interfaces is disabled.',Session::get('locale')) !!}
                            {!! create_label('click_to_change', 'Click here to change.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('verification_instructions', 'It looks like you\'re logged in as a different user. To verify the email associated with this link, please either:',Session::get('locale')) !!}
                            {!! create_label('log_out_and_try_again', 'Log out of your current account and try the verification link again, or',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('open_in_new_tab', 'Open the verification link in a new tab or an incognito window where no user is logged in.',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            {!! create_label('chat_settings_not_set', 'Important settings for the chat feature are not set.',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            {!! create_label('max_files_allowed_info', 'Set the maximum number of files that can be uploaded at a time. Also, set the `max_file_uploads` PHP configurations on your server accordingly to ensure the Max Files Allowed works as expected.',Session::get('locale')) !!}
                            {!! create_label('allowed_file_types_info', 'Specify the file types allowed for upload, separated by commas. Default: .pdf, .doc, .docx, .png, .jpg, .xls, .xlsx, .zip, .rar, .txt.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            {!! create_label('upcoming_work_anniversaries_section', 'Upcoming work anniversaries section',Session::get('locale')) !!}
                            {!! create_label('members_on_leave_section', 'Members on leave section',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('enable_upcoming_birthdays_section', 'Enable or disable showing the upcoming birthdays section on the dashboard page.',Session::get('locale')) !!}
                            {!! create_label('enable_upcoming_work_anniversaries_section', 'Enable or disable showing the upcoming work anniversaries section on the dashboard page.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('enable_mol_section', 'Enable or disable showing the members on leave section on the dashboard page.',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            ...
                            {!! create_label('important_settings_for_slack_notification_feature_to_be_work', 'Important settings for Slack notification feature to be work.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('slack_webhook_url', 'Slack Webhook URL',Session::get('locale')) !!}
                            {!! create_label('default_slack_template_info', 'A Default Title and Message Will Be Used if a Specific Slack Notification Template Is Not Set.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('project_assignment_slack_info', 'This template will be used for the slack notification sent to users/clients when they are assigned a project.',Session::get('locale')) !!}
                            {!! create_label('project_assignment_slack_will_not_sent', 'If Deactive, project assignment slack notification won\'t be sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('project_status_updation_slack_info', 'This Template Will Be Used for the slack notification sent to the Users/Clients Upon the Status Updation of a Project.',Session::get('locale')) !!}
                            {!! create_label('project_status_updation_slack_will_not_sent', 'If Deactive, Project Status Updation slack Notification won\'t be sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('task_assignment_slack_info', 'This template will be used for the slack notification sent to users/clients when they are assigned a task.',Session::get('locale')) !!}
                            {!! create_label('task_assignment_slack_will_not_sent', 'If Deactive, task assignment slack notification won\'t be sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('task_status_updation_slack_info', 'This Template Will Be Used for the slack notification sent to the Users/Clients Upon the Status Updation of a Task.',Session::get('locale')) !!}
                            {!! create_label('task_status_updation_slack_will_not_sent', 'If Deactive, Task Status Updation slack notification won\'t be sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('workspace_assignment_slack_info', 'This template will be used for the slack notification sent to users/clients when they are added to a workspace.',Session::get('locale')) !!}
                            {!! create_label('workspace_assignment_slack_will_not_sent', 'If Deactive, workspace assignment slack notification won\'t be sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('meeting_assignment_slack_info', 'This template will be used for the slack notification sent to users/clients when they are added to a meeting.',Session::get('locale')) !!}
                            {!! create_label('meeting_assignment_slack_will_not_sent', 'If Deactive, meeting assignment slack notification won\'t be sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('leave_request_creation_slack_info', 'This Template Will Be Used for the slack notification sent to the Admin and Leave Editors Upon the Creation of a Leave Request.',Session::get('locale')) !!}
                            {!! create_label('leave_request_creation_slack_will_not_sent', 'If Deactive, Leave Request Creation slack notification won\'t be sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('leave_request_status_updation_slack_info', 'This Template Will Be Used for the slack notification sent to the Admin/Leave Editors/Requestee Upon the Status Updation of a Leave Request.',Session::get('locale')) !!}
                            {!! create_label('leave_request_status_updation_slack_will_not_sent', 'If Deactive, Leave Request Status Updation slack Notification won\'t be sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('team_member_on_leave_alert_slack_info', 'This template will be used for the slack notification sent to team members upon approval of a leave request, informing them about the absence of the requestee.',Session::get('locale')) !!}
                            {!! create_label('team_member_on_leave_alert_slack_will_not_sent', 'If Deactive, Team Member on Leave Alert slack Notification Won\'t be Sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            {!! create_label('mind_map_collapse_info', 'Click the yellow dots to expand or collapse sections of the mind map.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            {!! create_label('confirm_update_task_end_date', 'Are You Want to Update the Task End Date?',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            {!! create_label('confirm_reset_default_menu', 'Are you sure you want to reset the menu order to the default?',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('search_menu', 'Search Menu...',Session::get('locale')) !!}
                            {!! create_label('permission_denied', 'You do not have permission to access this resource.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            {!! create_label('project_gantt_info', 'Double-click a project or task to view the detail page.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            {!! create_label('report_footer', 'This report was generated automatically. For any questions or concerns, please contact admin for support.',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            ...
                            {!! create_label('s', '\'s ',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            {!! create_label('confirm_delete_comment' , 'Are you sure you want to delete this comment?',Session::get('locale')) !!}
                            {!! create_label('hide', 'Hide',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            {!! create_label('test_slack_notification_settings_info', 'This is where you can test your Slack notification settings. Before testing, please update the settings if they haven\'t been updated already.',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            {!! create_label('no_role_assigned', 'You do not have any assigned role. Please contact the admin for assistance.',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            ...
                            {!! create_label('urgent_tasks_info', 'Tasks with a \'Danger\' priority color that have passed their due date are considered urgent.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            {!! create_label('please_enter_company_phone_number', 'Please Enter Company Phone Number',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            {!! create_label('company_info_info', 'This information will be displayed on estimates and invoices.', Session::get('locale')) !!}
                        ...
                        <div class="row">
                            {!! create_label('client_can_discuss_info', 'Allows the client to participate in project discussions.',Session::get('locale')) !!}
                            {!! create_label('client_can_discuss_info_task', 'Allows the client to participate in task discussions.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            {!! create_label('users_clients_duplicate_info', 'Users and Clients will be duplicated by default',Session::get('locale')) !!}
                        ...
                        <div class="row">
                            ...
                            {!! create_label('birthday_wish_email_info', 'This template will be used for the email notification sent to users/clients on their birthday, and it will be sent only if their status is active.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('birthday_wish_email_will_not_sent', 'If Deactive, birthday wish email notification won\'t be sent',Session::get('locale')) !!}
                            {!! create_label('birthday_wish_sms_info', 'This template will be used for the SMS notification sent to users/clients on their birthday, and it will be sent only if their status is active.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('birthday_wish_sms_will_not_sent', 'If Deactive, birthday wish SMS notification won\'t be sent',Session::get('locale')) !!}
                            {!! create_label('birthday_wish_whatsapp_info', 'This template will be used for the WhatsApp notification sent to users/clients on their birthday, and it will be sent only if their status is active.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('birthday_wish_whatsapp_will_not_sent', 'If Deactive, birthday wish WhatsApp notification won\'t be sent',Session::get('locale')) !!}
                            {!! create_label('birthday_wish_system_info', 'This template will be used for the WhatsApp notification sent to users/clients on their birthday, and it will be sent only if their status is active.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('birthday_wish_system_will_not_sent', 'If Deactive, birthday wish system notification won\'t be sent',Session::get('locale')) !!}
                            {!! create_label('birthday_wish_push_info', 'This template will be used for the push notification sent to users/clients on their birthday, and it will be sent only if their status is active.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('birthday_wish_push_will_not_sent', 'If Deactive, birthday wish push notification won\'t be sent',Session::get('locale')) !!}
                            {!! create_label('birthday_wish_slack_info', 'This template will be used for the slack notification sent to users/clients on their birthday, and it will be sent only if their status is active.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('birthday_wish_slack_will_not_sent', 'If Deactive, birthday wish slack notification won\'t be sent',Session::get('locale')) !!}
                            {!! create_label('work_anniversary_wish','Work Anni. Wish',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('work_anniversary_wish_email_info', 'This template will be used for the email notification sent to users/clients on their work anniversary, and it will be sent only if their status is active.',Session::get('locale')) !!}
                            {!! create_label('work_anniversary_wish_email_will_not_sent', 'If Deactive, work anniversary wish email notification won\'t be sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                            {!! create_label('work_anniversary_wish_sms_info', 'This template will be used for the SMS notification sent to users/clients on their birthday, and it will be sent only if their status is active.',Session::get('locale')) !!}
                            {!! create_label('work_anniversary_wish_whatsapp_info', 'This template will be used for the WhatsApp notification sent to users/clients on their work anniversary, and it will be sent only if their status is active.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        {!! create_label('work_anniversary_wish_whatsapp_will_not_sent', 'If Deactive, work anniversary wish WhatsApp notification won\'t be sent',Session::get('locale')) !!}
                        {!! create_label('work_anniversary_wish_system_info', 'This template will be used for the system notification sent to users/clients on their work anniversary, and it will be sent only if their status is active.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        {!! create_label('work_anniversary_wish_system_will_not_sent', 'If Deactive, work anniversary wish system notification won\'t be sent',Session::get('locale')) !!}
                        {!! create_label('work_anniversary_wish_push_info', 'This template will be used for the push notification sent to users/clients on their work anniversary, and it will be sent only if their status is active.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        {!! create_label('work_anniversary_wish_push_will_not_sent', 'If Deactive, work anniversary wish push notification won\'t be sent',Session::get('locale')) !!}
                        {!! create_label('work_anniversary_wish_slack_info', 'This template will be used for the slack notification sent to users/clients on their work anniversary, and it will be sent only if their status is active.',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        {!! create_label('work_anniversary_wish_slack_will_not_sent', 'If Deactive, work anniversary wish slack notification won\'t be sent',Session::get('locale')) !!}
                        {!! create_label('work_anniversary_wish_sms_will_not_sent', 'If Deactive, work anniversary wish SMS notification won\'t be sent',Session::get('locale')) !!}
                        </div>
                        <div class="row">
                        {!! create_label('wishes_noti_info', 'To send wish notifications automatically, you need to set up a cron job on your server.',Session::get('locale')) !!}                        
                        ...
                        {!! create_label('enter_site_url_without_trailing_slash', 'Enter the site URL without a trailing slash',Session::get('locale')) !!}                        
