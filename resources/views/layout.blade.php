...
<link rel="manifest" href="{{ asset('/manifest.json') }}">
    ...
    <meta name="description" content="A centralized platform for project coordination, creative ideas, and work management. Enhance collaboration and team productivity at PT Aperindo Prima Mandiri with Aperindo ProjectHUB." />
    <!-- Favicon -->
